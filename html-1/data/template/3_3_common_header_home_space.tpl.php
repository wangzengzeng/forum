...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1487029891, '3', './data/template/3_3_common_header_home_space.tpl.php', './template/bigstyle', 'common/header_home_space')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1487029891, '3', './data/template/3_3_common_header_home_space.tpl.php', './template/bigstyle', 'common/header_home_space')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1487029891, '3', './data/template/3_3_common_header_home_space.tpl.php', './template/bigstyle', 'common/header_home_space')
;?>
