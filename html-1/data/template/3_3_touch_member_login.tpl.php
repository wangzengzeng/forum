...
0
|| checktplrefresh('./template/bigstyle/touch/member/login.htm', './template/default/touch/common/seccheck.htm', 1486905720, '3', './data/template/3_3_touch_member_login.tpl.php', './template/bigstyle', 'touch/member/login')
...
<!-- header start --><?php include template('common/mwt_style'); ?><div class="mwt-h5bar" style="top: 0px; height: 40px;">
